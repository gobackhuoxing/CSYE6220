...
<div class="container-fluid bg-2 text-center">
  ...
  <table class="off">
		...
		<c:forEach var="comment" items="${comments}">
			<tr>
				<td><c:out value="${comment.user.username}"></c:out></td>
				<td><c:out value="${comment.user.name}"></c:out></td>
				<td><a class="sub"
					href="${pageContext.request.contextPath}/checkcomment?id=${comment.id}">
						<c:out value="${comment.subject}"></c:out>
				</a></td>
				<td>just now</td>
			</tr>
		</c:forEach>
	...
	<p>
		<a class="sub" href="${pageContext.request.contextPath}/newcomment">Add a new
			comment.</a>
	</p>
</div>
