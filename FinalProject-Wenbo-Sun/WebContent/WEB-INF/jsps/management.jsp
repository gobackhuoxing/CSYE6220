...
<div class="container-fluid bg-2 text-center">
  <h3 class="margin">User Management</h3>
  <sf:form method="post"
		action="${pageContext.request.contextPath}/managementuser"
		commandName="user">
		<table class="off">
			<tr>
				<td>User name</td>
		...
		<table class="off">
		<tr> <td>Role</td> <td>Enabled</td> </tr>		
		<tr>		
		<td><input class="t2" type="radio" name="authority"
					value="ROLE_USER"> User <input class="t2" type="radio"
					name="authority" value="ROLE_PRIME"> Prime User <input
					type="hidden" name="username" value="${user.username}"></td>

				<td><input class="t2" type="radio" name="enabled" value="true">
					True <input class="t2" type="radio" name="enabled" value="false">
					False <input type="hidden" name="username" value="${user.username}">
				</td>
				</tr>
				</table>
		<input class="confirm" value="Submit" type="submit">
	</sf:form>
