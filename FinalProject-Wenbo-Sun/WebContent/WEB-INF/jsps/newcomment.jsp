...
<div class="container-fluid bg-2 text-center">
  <h3 class="margin">What do you want to say?</h3>
  <sf:form method="post"
		action="${pageContext.request.contextPath}/commentcreated"
		commandName="comments">
		<sf:input type="hidden" path="id" />
		<table class="t1">
			<tr>
				<td class="tabletext">Subject:   </td>
				<td ><sf:textarea class="t2 tabletext" path="subject" rows="1" cols="20"></sf:textarea><br />
					<sf:errors path="subject" cssClass="error">
					</sf:errors></td>
			</tr>
			<tr>
				<td class="tabletext">Comment:</td>
				<td ><sf:textarea class="t2 tabletext" path="comment" rows="5" cols="20"></sf:textarea><br />
					<sf:errors path="comment" cssClass="error">
					</sf:errors></td>
			</tr>
			<tr>
				<td></td>
				<td class="tabletext"><input class="t2 loginbutton" value="Submit comment"
					type="submit"></td>
			</tr>
		</table>
	</sf:form>
